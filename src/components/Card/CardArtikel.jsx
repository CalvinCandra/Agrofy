  ...
  return (
    <div className="bg-white border border-b-2 border-gray-400 p-1 flex flex-col lg:flex-row rounded-lg my-5">
      ...
      <div className="lg:mx-10 flex flex-col justify-between lg:h-[300px]">
        <h1 className="text-black font-bold text-base mt-2 mx-2 text-center lg:text-left">
          {judul}
        </h1>

        <p className="lg:ml-1 w-full font-medium text-sm lg:text-base text-justify lg:text-justify mt-3 lg:mt-2 line-clamp-3">
          {deskripsi.replace(/<\/?[^>]+(>|$)/g, "")}
        </p>
